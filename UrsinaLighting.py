...
class LitObject(Entity):
    def __init__(self, model = 'plane', scale = 1, position = (0, 0, 0), rotation = (0, 0, 0), texture = None, collider = None,
                 ...
                 smoothness = 128, ambientStrength = 0.1, normalMap = None, specularMap = None, water = False, cubemapIntensity = 0.5,
                 onUpdate = lambda self: None, **kwargs):  #cubemap = "textures/cubemap_#.jpg",
        super().__init__(
            shader = LitShader,
            model = model,
            collider = collider,
...
if __name__ == "__main__":
    ...
    skyboxTexture = Texture("textures/sky_default.jpg")
    ...
    cube = LitObject(model = "cube", position = (0, 0.5, 1), texture = "textures/terrain_cube.png", specularMap = None, normalMap = None, ambientStrength = 0.5)
    cube_dirt = LitObject(model = "cube", position = (0, 0.5, 2), texture = "textures/dirt_cube.png", specularMap = None, normalMap = None, ambientStrength = 0.5)
